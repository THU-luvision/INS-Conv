...
public:
    ...
    inline unsigned get_num_unique_keys_build() const {return num_unique_keys_build_;}
    ...
    virtual bool Initialize(const unsigned max_input_size,
                            ...
                            const unsigned num_functions  = 5);
...
private:
    ...
    unsigned       num_unique_keys_build_;          // didn't support insert!
