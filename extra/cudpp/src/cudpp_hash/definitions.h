...
/* --------------------------------------------------------------------------
   ...
   -------------------------------------------------------------------------- */
#ifdef _DEBUG
  //! Forces the hash functions to generate a full set of slots for each key when not using subtables.
...
const unsigned kMaxRestartAttempts = 200;            //!< Number of build attempts.
